...
public class GameData {
    ...
    private static void initialiserMonstres() {
        ...
        monstres.add(new Monstre("Zombie", 20, 5, getItemParNom("Bois"), 0.4));
        monstres.add(new Monstre("Squelette", 15, 7, getItemParNom("Pierre"), 0.3));
        monstres.add(new Monstre("Creeper", 10, 10, getItemParNom("Fer"), 0.2));
    ...
    private static void initialiserRecettes() {
        ...
        // Recette pour une armure en fer : 8 fers
        recettes.put(
                Arrays.asList(getItemParNom("Fer"), getItemParNom("Fer"), getItemParNom("Fer"),
                        getItemParNom("Fer"), getItemParNom("Fer"), getItemParNom("Fer"),
                        getItemParNom("Fer"), getItemParNom("Fer")),
                new Armure("Armure en fer", 15, 1));

        // Recette pour une armure en or : 8 ors
        recettes.put(
                Arrays.asList(getItemParNom("Or"), getItemParNom("Or"), getItemParNom("Or"),
                        getItemParNom("Or"), getItemParNom("Or"), getItemParNom("Or"),
                        getItemParNom("Or"), getItemParNom("Or")),
                new Armure("Armure en or", 10, 2));

        // Recette pour une armure en diamant : 8 diamants
        recettes.put(
                Arrays.asList(getItemParNom("Diamant"), getItemParNom("Diamant"), getItemParNom("Diamant"),
                        getItemParNom("Diamant"), getItemParNom("Diamant"), getItemParNom("Diamant"),
                        getItemParNom("Diamant"), getItemParNom("Diamant")),
                new Armure("Armure en diamant", 15, 3));

    }

    private static Item getItemParNom(String nom) {
